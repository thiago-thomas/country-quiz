      ...
      <main>
        ...
        <div className="country-quiz__main-container">
          <div className="country-quiz__numbers-questions">
            <button type="button" className="answered">1</button>
            <button type="button" className="answered">2</button>
          ...
          <h2 className="country-quiz__question-text">Which country does this flag belong to?</h2>
          <div className="country-quiz__options-container">
            <button type="button" className="selected">Sweden</button>
